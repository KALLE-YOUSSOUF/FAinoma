            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center wow fadeInDown">
                        <h2 class="section-heading" style="color: #1C563D;"><strong>Produit 5</strong></h2>
                        
                    </div>
                    <div class="row gap">
                    <div class="col-md-4 wow fadeInLeft">
                        <img src="assets/images/fruits.jpg" class="img-responsive" />
                    </div>
                                ...
                                <div class="row">
                                    <ul class="direction-aware owl-carousel wow fadeInUp" data-items="5" data-items-tablet="[768,3]"  data-items-mobile="[479,1]">
                                        <li class="portfolio-item da-item">
                                            <a class="lb-link" href="assets/images/fruits.jpg" title="View Image">
                                                <img src="assets/images/fruits.jpg" class="img-responsive" alt="">
                                                <div>
